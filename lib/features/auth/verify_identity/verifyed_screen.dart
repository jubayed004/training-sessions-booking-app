...
class VerifyedScreen extends StatelessWidget {
  const VerifyedScreen({super.key});
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Gap(32),
                      CustomButton(text:AppStrings.goToDashboard.tr,onTap: ()=>AppRouter.route.goNamed(RoutePath.trainerNavScreen),)
                    ],
                  ),
                ),
              ],
